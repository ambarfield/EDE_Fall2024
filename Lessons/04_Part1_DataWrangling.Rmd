...
> Add notes here: Environmental changes over time, potentially related to climate change and human impact.
...
`==' - filter and compare values to a specific value
...
`|` - both to be TRUE, or if one or the other should be TRUE
...
NTL.phys.data.PeterPaul1 <- mutate(NTL.phys.data.PeterPaul1, 
