...
Rainfall.ts <- ts(BR_complete$Rainfall, start = c(1901,1), frequency = 12)

Temperature.ts <- ts(BR_complete$Temperature_C, start = c(1901,1), frequency = 12)
...
Rainfall.Components <- as.data.frame(Rainfall.Decomposed$time.series)

Temperature.Components <- as.data.frame(Temperature.Decomposed$time.series)

Rainfall.Components <- mutate(Rainfall.Components,
                              Observed = BR_complete$)

# Exercise 10: Visualize how the trend maps onto the data for both series

Rainfall.Components.Plot <-
