...
> Answer: Attaching package and objects masked from the package (when two packages have the same command)
...
read.csv('Data/Raw/USGS_Site02085000_Flow_Raw.csv')f
...
> ANSWER: You can find this file in the "Metadata" folder. 
