...
```{r echo=FALSE, fig.align='left', fig.cap="2018 monthly Ozone levels", fig.height= 3, fig.width= 7, message=FALSE, warning=FALSE}
epa_data$Month <-
  factor(epa_data$Month, levels = 1:12, labels = month.abb)
...
epa_data %>%
  ...
  ylab ("Concentrations (ug/m3)")

```

```{r echo=FALSE, fig.align='left', fig.cap="2019 monthly Ozone levels", fig.height= 3, fig.width = 7, message=FALSE, warning=FALSE}
...
https://github.com/ambarfield/EDE_Fall2024.git
